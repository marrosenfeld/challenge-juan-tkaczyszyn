...
class App extends React.Component {
  ...
  componentWillMount() {
    ...
    if(!this.props.appStore.user || !this.props.appStore.user.authorities){
      // this.props.actions.loadUser();
    }
    console.log("app.index componentWillMount")
    // dispatch this action to load the menu
    this.props.actions.loadMenu(this.props.appStore.user);
  }
  ...
  renderPages() {
    ...
    //
    // if(this.props.appStore.userIsAuthenticated && (!this.props.appStore.user || !this.props.appStore.user.authorities) ){
    //   this.props.actions.loadUser();
    //   this.props.actions.loadMenu(this.props.appStore.user);
    // }
    ...
    } else if (this.props.appStore.userIsAuthenticated && this.props.appStore.user /*&& this.props.appStore.user.authorities*/) {
