...
import { setProperty } from '../styles'
              ...
              nestedItems={this.props.appStore.menus.length > 0 ?
                this.props.appStore.menus.map((menu) =>
                  <ListItem
                    ...
                    value={menu.index}
                    style={this.props.appStore.selectedMenuIndex === menu.index ? setProperty(styles.selectedMenuListItem, 'color', menu.color) :  setProperty(styles.menuItem, 'color', menu.color)}
                    ...
                    nestedItems={menu.children && menu.children.length > 0 ?
                      menu.children.map((child) =>
                        <ListItem
                          ...
                          value={child.index}
                          style={this.props.appStore.selectedMenuIndex === child.index ? setProperty(styles.selectedMenuListItem, 'color', menu.color) : setProperty(styles.menuItem, 'color', menu.color)}
